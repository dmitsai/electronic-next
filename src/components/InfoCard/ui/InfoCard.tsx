...
export const InfoCard: React.FC<InfoCardProps> = ({ placeholder, children, icon }) => {
    return (
        <div className="flex flex-col relative justify-center items-center h-80 ">
            ...
            <div className="flex flex-col rounded-xl bg-white pt-24 pb-14 px-12 gap-y-5 text-black relative justify-center items-center">
